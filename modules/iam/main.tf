...
######## Just to add suffix so that resources remain unique ######
...
######## Attaching Required Policy to Role ##############
...
############## Attaching REquired Policy to Nodegroup Role #####
...
######## Attaching ALB controller policy that we created to Nodegroup ###########
...
######## Creating Role for OIDC #######
resource "aws_iam_role" "eks_oidc" {
  assume_role_policy = data.aws_iam_policy_document.eks_oidc_assume_role_policy.json
  name               = "eks-oidc"
}

##### Attaching OIDC Policy #######
...
######### Attachind Admin Policy to Bastion ######
